...
def parse_amount_of_atoms(formula: str) -> dict:
    element = ""
    element_hash = {}
...
def parse_molar_mass(formula: str) -> float:
    mass = 0
    for element, amount in parse_amount_of_atoms(formula).items():
        mass += molar_mass[element] * amount
    return mass
